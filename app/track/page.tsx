    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-6 sm:py-12 px-4 max-w-3xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">Traccia il tuo ordine</h1>
        ...
        {/* I miei ordini salvati */}
        {storedOrders.length > 0 && (
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Clock className="h-5 w-5" />
                I miei ordini (su questo dispositivo)
              </CardTitle>
              <CardDescription>
                Accesso rapido ai tuoi ordini recenti
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
        ...
        <div className="p-4 bg-muted/50 rounded-lg border">
          <h3 className="font-semibold mb-2 text-sm">Dove trovo il numero ordine?</h3>
          <p className="text-sm text-muted-foreground">
            Il numero ordine ti è stato fornito nella pagina di conferma dopo aver completato l'ordine. 
            Ha un formato simile a: <span className="font-mono font-semibold">ORD-20240216-ABCD</span>
          </p>
        </div>
      </main>
    </div>
